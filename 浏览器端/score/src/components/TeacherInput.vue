<template>
    <el-container>
        <el-main>
            <div class="table">
                <el-table :data="tableData" border height="550" empty-text="暂无数据">
            ...
            <el-row type="flex" justify="center" align="middle">
                ...
                <el-col :span="6">
                    ...
                    <div class="course-div">
                        <el-input v-model="courseId" placeholder="请输入课程号" maxlength="9" minlength="9" prefix-icon="el-icon-search"></el-input>
                    </div>
                </el-col>
